...
/// @notice Six-decimal PBLC test token with the EIP-3009 exact-transfer primitive used by x402 v2.
/// @dev This is a new, non-upgradeable deployment. DemoToken V1 and its Permit2 path remain intact.
